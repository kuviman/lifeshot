...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "lifeshot.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "lifeshot.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'lifeshot'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'lifeshot':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_75fb0901578e81fd243ae798078cbfdb9f353ec1": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){var audio=new Audio(($1));audio.play();return audio;})());
            },
            ...
            "__cargo_web_snippet_7d72c247afbf28e8b1707ace0f603812d50f9952": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){var document=window.document;if(document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement){return true;}else{return false;}})());
            },
            ...
            "__cargo_web_snippet_884b7ba6a40155dfa7fd7cc88e0ac36c54ace519": function() {
                var music=new Audio("music.ogg");music.volume=0.2;music.addEventListener("ended",function(){this.currentTime=0;this.play();},false);music.play();
            },
            ...
            "__cargo_web_snippet_d65a7d895b0db8d61befba6b057173d4c6596106": function() {
                var document=window.document;if(document.cancelFullScreen){document.cancelFullScreen();}else if(document.msExitFullscreen){document.msExitFullscreen();}else if(document.mozCancelFullScreen){document.mozCancelFullScreen();}else if(document.webkitCancelFullScreen){document.webkitCancelFullScreen();}
            },
            ...
            "__cargo_web_snippet_e8f17f951fe092a64198bcfa044841448fe33820": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0).volume=($1)*0.2;
            },
            ...
            "__cargo_web_snippet_f1040e6de061d31fbeb73f697358224ba6c03c9a": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);var elem=($0);if(elem.requestFullscreen){elem.requestFullscreen();}else if(elem.msRequestFullscreen){elem.msRequestFullscreen();}else if(elem.mozRequestFullScreen){elem.mozRequestFullScreen();}else if(elem.webkitRequestFullscreen){elem.webkitRequestFullscreen();}
            },
